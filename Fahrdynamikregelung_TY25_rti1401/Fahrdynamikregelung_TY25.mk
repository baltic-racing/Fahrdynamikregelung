...
#
#  $RCSfile: rti1401.tmf $ $Revision: 2.111 $ $Date: 2020/08/18 11:51:29CEST $
...
MAKEFILE                       = Fahrdynamikregelung_TY25.mk
...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2022b\bin
RELEASE_VERSION                = R2022b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = Fahrdynamikregelung_TY25
MODULES                        = Fahrdynamikregelung_TY25_data.c Fahrdynamikregelung_TY25_trc_ptr.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = C:\Users\shoot\Documents\GitHub\Fahrdynamikregelung
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\Fahrdynamikregelung_TY25_rti1401" \
...
TMP_PATH_CC += "C:\PROGRA~1\DSPACE~4\MATLAB\RTICAN\TLC"
TMP_PATH_CC += "$(MATLAB_ROOT)\rtw\c\src"
...
make_success :
	...
	%if   '$(MODEL)' != 'rtwshared'
		%ifdef HAS_COMPILED 
			...
			%endif
		%elseif $(RELEASE_VERSION) == '2019a' || $(RELEASE_VERSION) == '2019b' || $(RELEASE_VERSION) == '2020a'
			%echo $(BUILD_SUCCESS)
			%ifdef VERBOSEFLAG
				%echo $(BUILD_SUCCESS) > CON
			%endif
